...
@Retention(AnnotationRetention.RUNTIME) //аннотация @LoginMember будет доступна в байт-коде и её можно будет прочитать во время выполнения программы с помощью рефлексии
