...
object ValidationMessages {
    object Invalid {
        ...
        const val PRICE_MUST_SCALE = "Price must have up to ${ConstantsProduct.Validation.PRICE_DECIMAL_SCALE}} decimal places"
        const val IMAGE_URL_MUST_LENGTH = "Name must be between 1 and ${ConstantsProduct.Validation.IMAGE_URL_MAX_LENGTH} characters"
