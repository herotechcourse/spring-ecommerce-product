...
class CartControllerIntegrationTest @Autowired constructor(
    ...
    fun setup() {
        ...
        product1 = Product(name = "walnut ice", price = 1.25, imageUrl = "https://m1.quebecormedia.com/emp/cl_prod/0c812707039196cfd54e13449059d16b5754cfc6/Screenshot-2023-06-02-at-2-31-16-PM.jpg?impolicy=resize&width=1500&height=1500")
        product1.id = productRepository.create(product1)

        product2 = Product(name = "almond ice", price = 1.50, imageUrl = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuUj5GRmKPJKaPk4PG_Ref3J0c-HnONIh29A&s")
