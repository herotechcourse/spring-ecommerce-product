...
class ProductRepositoryTest
    ...
    constructor(
        ...
        fun `it should count the products`() {
            productRepository.create(Product(id = 1, "test", 20.0, "astr", 20))
            productRepository.create(Product(id = 2, "test", 20.0, "astr", 20))
            productRepository.create(Product(id = 3, "test", 20.0, "astr", 20))
        ...
        fun `it should find a product by id`() {
            ...
            assertThat(productRepository.findById(1)).isEqualTo(Product(id = 1, "test", 20.0, "astr", 20))
        }
        ...
        fun `it should return all products`() {
            ...
            assertThat(productRepository.findAllProducts()).isEqualTo(
                listOf(
                    Product(id = 1, "test", 20.0, "astr", 20),
                    Product(id = 2, "test", 20.0, "astr", 20),
                    Product(id = 3, "test", 20.0, "astr", 20),
                ).toList(),
            )
        }
